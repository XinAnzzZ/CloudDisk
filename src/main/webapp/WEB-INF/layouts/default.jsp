...
<head>
    ...
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/statics/jquery/jquery-1.11.2.min.js"></script>
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/statics/jquery/blockUI/2.70.0/jquery.blockUI.js"></script>
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/statics/jQuery-dataTables/DataTables-1.10.15/js/jquery.dataTables.js"></script>
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/statics/jQuery-dataTables/DataTables-1.10.15/js/dataTables.bootstrap.min.js"></script>
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/statics/jQuery-dataTables/jQuery.dataTables.ext.js"></script>
    ...
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/statics/jQuery-dataTables/DataTables-1.10.15/css/jquery.dataTables.min.css"
          type="text/css">
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/statics/jQuery-dataTables/DataTables-1.10.15/css/dataTables.bootstrap.min.css"
          type="text/css">
