                ...
                <el-row>
                    <el-col :span="8">
                        <el-card :body-style="{ padding: '20px' }">
                            <img src="${pageContext.request.contextPath}/statics/img/BI_1ZR%7D%7DYJ6OWJ%60%7D51D%5B%2536.png" class="image">
                    ...
                    <el-col :span="8">
                        <el-card :body-style="{ padding: '20px' }">
                            <img src="${pageContext.request.contextPath}/statics/img/JL%5BAHNLJ9%7D~NW%7BNYJ%5B1J19T.png" class="image">
                            <div style="padding: 14px;">
                                <div class="bottom clearfix">
                    ...
                    <el-col :span="8">
                        <el-card :body-style="{ padding: '20px' }">
                            <img src="${pageContext.request.contextPath}/statics/img/Z@735@HBL52V6%60()ZO1G7I5.png" class="image">
                            <div style="padding: 14px;">
                                <div class="bottom clearfix">
