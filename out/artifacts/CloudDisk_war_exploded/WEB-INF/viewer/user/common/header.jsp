...
<el-header class="bg-color" style="height: 61px;    text-align: right">
    <el-menu default-active="1" class="el-menu-demo" mode="horizontal"
        ...
        <el-menu-item index="/files/share/list/page" style="background-color: rgb(240, 244, 247);"><a href="${pageContext.request.contextPath}/files/share/list/page">我的分享</a></el-menu-item>
