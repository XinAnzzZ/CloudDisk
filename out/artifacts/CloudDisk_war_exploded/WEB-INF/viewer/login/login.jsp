                    ...
                    <el-form :model="loginForm" status-icon :rules="rules2" ref="loginForm"
                        ...
                        <div class="grid-content ">
                            ...
                            <el-form-item prop="rememberMe">
                                <el-checkbox border color="red" name="rememberMe" v-model="loginForm.rememberMe"><span style="color: #ffffff">记住我</span></el-checkbox>
                            </el-form-item>
                            <el-form-item>
...
<script src="${pageContext.request.contextPath}/statics/systemjs/login-all.js?t=20140427000" type="text/javascript"></script>
