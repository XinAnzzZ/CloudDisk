...
<el-header class="bg-color" style="height: 61px;    text-align: right">
    <el-menu default-active="1" class="el-menu-demo" mode="horizontal"
        ...
        <el-menu-item index="1" style="background-color: rgb(240, 244, 247);">管理中心</el-menu-item>
        <el-dropdown style="line-height: 60px;">
            ...
            <el-dropdown-menu slot="dropdown">
                <el-dropdown-item>
                    <a href="${pageContext.request.contextPath}/admin/personal/profile" style="color: black">个人中心</a>
                </el-dropdown-item>
                <el-dropdown-item>
                    <a onclick="logout()" style="color: black">退出</a>
                </el-dropdown-item>
            </el-dropdown-menu>
        </el-dropdown>
    </el-menu>
