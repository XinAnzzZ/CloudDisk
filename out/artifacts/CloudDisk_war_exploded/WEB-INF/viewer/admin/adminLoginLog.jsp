                    ...
                    <el-form-item label="开始时间">
                        <el-form-item prop="loginDateStart">
                            <el-date-picker type="datetime"  value-format="yyyy-MM-dd HH:mm:ss"
                                            v-model="recordForm.loginDateStart" placeholder="请选择起始时间"></el-date-picker>
                        </el-form-item>
                    </el-form-item>
                    <el-form-item label="结束时间">
                        <el-form-item prop="loginDateEnd">
                            <el-date-picker type="datetime" value-format="yyyy-MM-dd HH:mm:ss"
                                            v-model="recordForm.loginDateEnd" placeholder="请选择终止时间"></el-date-picker>
                        </el-form-item>
...
<script type="application/javascript">
    ...
    new Vue({
        ...
        data: {
            ...
            activeIndex: "/admin/login/record"
        },
        methods: {
