!function (e) {
    ...
    var needShowAge = false;
    var needPutAge = false;
    var g = function (k, j) {
        if (j.needShowAge) {
            needShowAge = true;
        }
    ...
    g.prototype = {
        constructor: g, _events: [], _attachEvents: function () {
            ...
            u -= 1;
            for (var B = -1; B < 11; B++) {
                var age = (new Date().getFullYear() - u);
                var spanStyle = 'style="line-height: 28px;"';
                var tmpAgeNum = age;
                if (age < 0) {
                    age = "";
                } else {
                ...
                var bstyle = '<br> <b class="sui" style=" font-weight: normal;">' + age + '</b>';
                if (!needShowAge) {
                    age = "";
                    spanStyle = "";
                    bstyle = "";
                ...
                if (needPutAge) {
                    ...
                    s += '<span onclick="setAgeInput(' + tmpAgeNum + ');" class="year' + (B == -1 || B == 10 ? " old" : "") + (L == u ? " active" : "") + (u < z || u > q ? " disabled" : "")
                        + '" ' + spanStyle + '>'
                        + u +
                        bstyle +
                        "</span>";
                } else {
                    s += '<span class="year' + (B == -1 || B == 10 ? " old" : "") + (L == u ? " active" : "") + (u < z || u > q ? " disabled" : "")
                        + '" ' + spanStyle + '>'
                        + u +
                        bstyle +
                        "</span>";
