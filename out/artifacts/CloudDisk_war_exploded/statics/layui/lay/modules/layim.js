...
;layui.define(["layer", "laytpl", "upload"], function (i) {
    var a = "3.7.5", e = layui.$, t = layui.layer, n = layui.laytpl, l = layui.device(), s = "layui-show",
        o = "layim-this", d = 100, r = {}, c = function () {
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        ...
        if (i.timestamp = i.timestamp || (new Date).getTime(), i.fromid == j.mine.id && (i.mine = !0), i.system || B(i), G = JSON.parse(JSON.stringify(i)), j.base.voice && F(i), !w && i.content || l === -1) {
        ...
        status: function (i, a) {
            ...
            layui.upload.render({
                ...
                accept: a,
                    ...
                    var tempName = "下载文件";
                    if (i.data.src.length > 0 && i.data.src.indexOf("/statics/temp/") === 0) {
                        tempName = i.data.src.replace("/statics/temp/", "");
                    }

                    0 == i.code ?
                        (i.data = i.data || {}, "images" === a ? ai(n.textarea[0], "img[" + (i.data.src || "") + "]")
                            : "file" === a && ai(n.textarea[0],
                            "file(" + (i.data.src || "") + ")[" + (i.data.name || tempName) + "]"), D()) : t.msg(i.msg || "上传失败")
                }
            })
        }, media: function (i) {
